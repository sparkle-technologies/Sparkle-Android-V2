...
public class CircleImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.cyberflow.base.resources.R.styleable.CircleImageView, defStyle, 0);

        mBorderWidth = a.getDimensionPixelSize(com.cyberflow.base.resources.R.styleable.CircleImageView_civ_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(com.cyberflow.base.resources.R.styleable.CircleImageView_civ_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(com.cyberflow.base.resources.R.styleable.CircleImageView_civ_border_overlay, DEFAULT_BORDER_OVERLAY);
        mCircleBackgroundColor = a.getColor(com.cyberflow.base.resources.R.styleable.CircleImageView_civ_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
