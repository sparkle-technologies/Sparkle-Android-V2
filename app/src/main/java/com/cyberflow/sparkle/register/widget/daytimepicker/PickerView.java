...
public class PickerView extends View {
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(getContext(), com.cyberflow.base.resources.R.color.gray_1st);
        mDarkColor = ContextCompat.getColor(getContext(), com.cyberflow.base.resources.R.color.black);
    }
