package com.cyberflow.sparkle.register.widget.daytimepicker;
...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private TextView mTitle, mTvHourUnit;
    ...
    private boolean mCanShowPreciseDate;
    ...
    private void initView() {
        mPickerDialog = new Dialog(mContext, com.cyberflow.base.resources.R.style.date_picker_dialog);
     ...
     * 设置日期控件是否显示年月日
     */
    public void setCanShowPreciseDate(boolean canShowPreciseDate) {
        if (!canShow()) return;

        if (canShowPreciseDate) {
        ...
        mCanShowPreciseDate = canShowPreciseDate;
    }
