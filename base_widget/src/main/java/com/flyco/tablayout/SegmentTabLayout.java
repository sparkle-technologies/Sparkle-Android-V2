...
import com.cyberflow.sparkle.widget.R;
...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mCornerRadius = ta.getDimension(R.styleable.SegmentTabLayout_tl_bar_corner_radius, -1);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mRectDrawable.setCornerRadius(mCornerRadius);   // 改了这里
        ...
        mIndicatorDrawable.setStroke(dp2px(1), Color.BLACK); // 改的代码
