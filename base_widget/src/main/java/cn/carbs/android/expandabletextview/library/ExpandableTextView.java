...
public class ExpandableTextView extends androidx.appcompat.widget.AppCompatTextView{
    ...
    private void init() {
        ...
        if(TextUtils.isEmpty(mToExpandHint)){
            mToExpandHint = getResources().getString(com.cyberflow.base.resources.R.string.to_expand_hint);
        }
        if(TextUtils.isEmpty(mToShrinkHint)){
            mToShrinkHint = getResources().getString(com.cyberflow.base.resources.R.string.to_shrink_hint);
        }
        if(mToggleEnable){
