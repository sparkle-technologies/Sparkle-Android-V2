...
public class DemoModel {
    ...
    public DemoDbHelper getDbHelper() {
        return DemoDbHelper.getInstance(BaseApp.getInstance());
    }
...
//        }
    ...
    public boolean isFirstInstall() {
        SharedPreferences preferences = BaseApp.getInstance().getSharedPreferences("first_install", Context.MODE_PRIVATE);
