...
public class DeleteMsgDialog extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.dialog_delete_msg, container);
    }
...
//        tvMsg.setOnClickListener(this);
    ...
    private void initDialogStyle() {
        ...
        if (dialog != null) {
            ...
            if (window != null) {
                ...
                window.setWindowAnimations(com.hyphenate.easeui.R.style.PictureThemeDialogFragmentAnim);
            }
        }
    }
    ...
    public void onClick(View v) {
        ...
        if (onItemClickListener != null) {
            if (id == R.id.tv_msg) {
                onItemClickListener.onItemClick(v, TYPE_OK);
                isCancel = false;
            } else if (id == R.id.tv_ok) {
                onItemClickListener.onItemClick(v, TYPE_CANCEL);
                isCancel = false;
            }
        }
