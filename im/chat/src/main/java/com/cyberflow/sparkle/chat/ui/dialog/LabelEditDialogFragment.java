...
public class LabelEditDialogFragment extends BaseDialogFragment {
    ...
    public static void getSoftKeyboardHeight(final View rootView, final OnGetSoftHeightListener listener) {
        final ViewTreeObserver.OnGlobalLayoutListener layoutListener
            ...
            public void onGlobalLayout() {
                ...
                //设置一个阀值来判断软键盘是否弹出
                boolean visible = heightDifference > screenHeight / CHILD_SIZE;
                if(!visible){
                    return;
                }
                if (listener != null) {
    ...
    private final static int CHILD_SIZE = 4;
    ...
    public static class KeyboardStateObserver {
        ...
        private void possiblyResizeChildOfContent() {
            ...
            if (usableHeightNow != usableHeightPrevious) {
                ...
                if (heightDifference > (usableHeightSansKeyboard / CHILD_SIZE)) {
                    if (listener != null) {
