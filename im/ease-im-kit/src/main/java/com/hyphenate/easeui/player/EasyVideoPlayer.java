...
public class EasyVideoPlayer extends FrameLayout implements EasyIUserMethods,
    ...
    private String TAG = "EasyVideoPlayer";
    ...
    private ImageButton mBtnSeekBarPlayPause;
    ...
    private Drawable mFullPlayDrawable;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mHideControlsOnPlay = a.getBoolean(R.styleable.EasyVideoPlayer_easy_hideControlsOnPlay, true);
                ...
                mThemeColor = a.getColor(R.styleable.EasyVideoPlayer_easy_themeColor, Util.resolveColor(context, R.attr.colorPrimary));
        ...
        if(mFullPlayDrawable == null){
            mFullPlayDrawable = AppCompatResources.getDrawable(context, R.drawable.easy_action_fullscreen_play);
        }
    ...
    public void setPlayDrawable(@NonNull Drawable drawable) {
        ...
        if (!isPlaying()) mBtnSeekBarPlayPause.setImageDrawable(drawable);
    }
...
//        mBtnPlayPause.setAlpha(enabled ? 1f : disabledAlpha);
    ...
    public void start() {
        ...
        mBtnSeekBarPlayPause.setImageDrawable(mPauseDrawable);
    ...
    public void pause() {
        ...
        mBtnSeekBarPlayPause.setImageDrawable(mPlayDrawable);
...
//            if (!mControlsDisabled && mHideControlsOnPlay) hideControls();
            ...
            mPlayer.pause();
            mBtnSeekBarPlayPause.setImageDrawable(mPlayDrawable);
            mBtnPlayPause.setImageDrawable(mFullPlayDrawable);
            mBtnPlayPause.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.transparent));
            mBtnPlayPause.setVisibility(INVISIBLE);
        }
    }
    ...
    private void initControlsFrame() {
        ...
        mBtnSeekBarPlayPause = mControlsFrame.findViewById(R.id.iv_seek_bar_play_pause);
        mBtnSeekBarPlayPause.setOnClickListener(this);
    ...
    @Override
    public void onClick(View view) {
        if (view.getId() == R.id.btnPlayPause) {  // 屏幕中间  只能暂停
            start();
        }

        if(view.getId() == R.id.iv_seek_bar_play_pause){  // 进度条左边  可暂停 可开始
