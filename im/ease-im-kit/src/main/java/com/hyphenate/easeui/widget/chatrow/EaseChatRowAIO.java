...
public class EaseChatRowAIO extends EaseChatRow {
    ...
    public EaseChatRowAIO(Context context, boolean isSender) {
        super(context, isSender);
    }

    public EaseChatRowAIO(Context context, EMMessage message, int position, Object adapter) {
        super(context, message, position, adapter);
    }

    @Override
    protected void onInflateView() {
        inflater.inflate(R.layout.ease_row_received_aio, this);
    }
    ...
    protected void onFindViewById() {
        ...
        tv2_bottom =  findViewById(R.id.tv3_bottom);
