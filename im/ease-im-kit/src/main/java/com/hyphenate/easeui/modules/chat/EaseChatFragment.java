...
public class EaseChatFragment extends EaseBaseFragment implements OnChatLayoutListener, OnMenuChangeListener,
    ...
    public void onBackPress() {
        if(chatLayout.rootLinearLayout.getCurrentInput() != null ){
            chatLayout.rootLinearLayout.hideAttachedInput(true);
            chatLayout.inputMenu.closeConversationInputPanel();
        }
    }
